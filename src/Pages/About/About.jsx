    ...
    return (
        <div className=' text-white  mx-auto pb-2'>
           ...
           <div className='md:mx-10 mx-4 text-justify space-y-5'>
                <div>
                    <h2 className='font-bold md:text-[20px] text-info text-[16px]'>Our Mission</h2>
                ...
                <div>
                    <h2 className='font-bold md:text-[20px] text-info text-[16px]'>Our Vision</h2>
                ...
                <div>
                    <h2 className='font-bold md:text-[20px] text-[16px] text-info'>Our Values</h2>
                ...
                <div>
                    <h2 className='font-bold md:text-[20px] text-[16px] text-info'>Our History</h2>
                ...
                <div>
                    <h2 className='font-bold md:text-[20px] text-[16px] text-info'>Community Involvement</h2>
                ...
                <div>
                    <h2 className='font-bold md:text-[20px] text-[16px] text-info'>Future Plan</h2>
