...
const Defaultuser = () => {
    ...
    return (
        <div>
            ...
            <div
                style={{
                    maxHeight: 'calc(100vh - 20px)', // Adjust based on your header/footer size
                    overflowY: 'auto',
                    padding: '10px',
                }}
            >
                ...
                <section className='text-white mx-4'>
                    <div className='my-10 lg:container lg:mx-auto mx-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 '>
                        <div className=' bg-gradient-to-r from-[#7870c0] to-[#5449bb] h-[200px] rounded-lg shandow flex flex-col justify-center items-center'>
                            ...
                            {
                                curehubUser?.plan ? <p className='text-lg font-semibold'>{curehubUser?.plan}</p>
                                    : <div>
                                    <p className='text-lg font-semibold'>No Plan Yet {curehubUser?.plan}</p>
                                    <button
                                onClick={() => {
