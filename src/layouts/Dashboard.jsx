...
const Dashboard = () => {
    ...
    return (
        <div className="relative min-h-[100vh] bg-gray-400 overflow-hidden">
                            ...
                            role && role === 'user' ? <>
                                ...
                                <Link to='/dashboard' className="py-4 pl-5 hover:bg-gray-400 hover:text-black flex gap-2 items-center">
                                    ...
                                    <li className="font-semibold">
                                        Account</li></Link>
                                    <hr className='border-2 ' />
                                    <Link to='/dashboard/alluser' className="py-4 pl-5 hover:bg-gray-400 hover:text-black flex gap-2 items-center">
                                        <MdAccountCircle className="text-xl " />
                                        <li className="font-semibold">
                                            All Users</li></Link>
                                    <hr className='border-2' />
                                    <Link to='/dashboard/doctors' className="py-4 pl-5 hover:bg-gray-400 hover:text-black flex gap-2 items-center">
                                        <MdAccountCircle className="text-xl " />
                                        <li className="font-semibold">
                                            All Doctors</li></Link>
                                    <hr className='border-2' />
